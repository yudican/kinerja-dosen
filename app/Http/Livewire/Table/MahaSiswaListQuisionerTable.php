...
class MahaSiswaListQuisionerTable  extends LivewireDatatable
{
  ...
  {
    return QustionAnswerDetail::query()->where('qustion_answer_details.user_id', $this->params['user_id'])->where('qustion_answer_details.data_jadwal_id', $this->params['quis_id'])->groupBy('user_id');
  }
